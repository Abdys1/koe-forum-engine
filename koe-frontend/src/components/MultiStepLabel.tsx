...
export default function MultiStepLabel(props: MultiStepLabelProps) {
    return (
        <li className={`relative flex justify-center items-center flex-col`}>
            <div className={clsx(
                `relative text-lg w-8 h-8 flex justify-center items-center bg-darkBtn font-bold rounded-[50%] font-roboto z-10`,
            ...
            {<h6 className={clsx(
                `absolute top-10 text-xs font-poppins tracking-widest`,
