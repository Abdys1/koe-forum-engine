...
export default function CharacterRaceBtn({ title, active = false, onClick }: CharacterRaceBtnProps) {
    return (
        <li className={clsx(`relative w-48 h-11 mb-4 flex justify-start items-center bg-cardMediumBg rounded-sm outline outline-1 outline-offset-2  hover:outline-mainLight overflow-hidden cursor-pointer z-10
