...
export default function MultiStepNavBtn(props: MultiStepNavBtnProps) {
    return (
        <button className={clsx(`relative w-36 py-1 mx-2 my-0 border-solid border-2  rounded tracking-wider font-poppins font-medium transition-all duration-500 ease-in-out`,
