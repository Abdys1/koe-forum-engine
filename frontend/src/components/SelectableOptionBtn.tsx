...
export default function SelectableOptionBtn(props: SelectableOptionBtnProps) {
    return (
        <button type="button"
            className={clsx(`relative w-28 py-0.5 m-2 border-solid border-2 border-secondary rounded-lg tracking-widest font-poppins font-medium hover:bg-secondary hover:text-cardMediumBg transition duration-300 ease-out`,
