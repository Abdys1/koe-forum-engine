...
export default function TabbedListPanel(props: TabbedListPanelProps) {
    ...
    return (
        <div className="relative w-full max-w-lg h-72  flex justify-center items-start flex-col rounded overflow-hidden
            ...
            <div className="relative w-full h-full mt-8 pt-1 px-4 pb-3 flex justify-start items-center flex-col bg-gradient-to-b from-[rgba(255,255,255,0.2)] to-[rgba(255,255,255,0.05)] overflow-y-auto z-10 scrollbar-thumb-rounded-full scrollbar-thin scrollbar-track-transparent scrollbar-thumb-mainLight">
