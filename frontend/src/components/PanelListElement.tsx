...
export default function PanelListElement(props: PanelListElementProps) {
    return (
        <li className="relative list-none w-[calc(100% - 4rem)] h-9 min-h-9 pl-4 my-3 flex justify-between items-center text-white text-sm font-medium tracking-wider font-poppins bg-gradient-to-t from-cardMediumBg to-cardBlackBg rounded-sm overflow-hidden z-20
