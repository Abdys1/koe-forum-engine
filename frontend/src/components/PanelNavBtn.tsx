...
export default function PanelNavBtn(props: PanelNavBtnProps) {
    return (
        <span className={clsx(`relative w-1/3 h-full flex justify-center items-center text-white text-sm font-medium tracking-wide uppercase font-poppins bg-cardMediumbg overflow-hidden cursor-pointer transition-all duration-300 ease-in-out z-10
